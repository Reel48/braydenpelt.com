...
export default function DataCenterEnergyPage() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-6xl">
      <h1 className="text-4xl font-bold mb-4 text-primary">US Data Center Energy Consumption</h1>
      <p className="text-gray-600 mb-8 text-lg">
        Projected growth of data center energy consumption from 2023 to 2030.
      </p>
